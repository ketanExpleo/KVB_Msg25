package com.fss.card.acquirer.format;
...
public final class TangoFormat extends ISOFormat {

	private static final TangoFormat TANGO_FORMAT = new TangoFormat("TANGO");
	...
	private TangoFormat(final String name) {
		super(name);
		...
		lencoder[BIN_LENGTH_ENCODER_INDEX]     = LengthEncoding.CHAR.encoder;

		length[NET_HEADER_INDEX]   = 12;
		...
		length[3]   = 6;
		encoder[3] = NUM.encoder;

		length[4]   = 12;
		encoder[4] = NUM.encoder;
