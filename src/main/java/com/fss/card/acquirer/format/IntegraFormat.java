...
public final class IntegraFormat extends ISOFormat {

	private static final IntegraFormat INTEGRA_FORMAT = new IntegraFormat("INTEGRA");
	
	public static final ISOFormat getInstance() {
		return INTEGRA_FORMAT;
	}
	
	
	private IntegraFormat(final String name) {
		super(name);
